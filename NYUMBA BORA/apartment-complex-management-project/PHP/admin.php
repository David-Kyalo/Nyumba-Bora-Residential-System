<?php
    require_once('authenticate.php'); // Include authentication file to verify user login
    error_reporting(E_ALL & ~E_NOTICE); // Suppress error reporting for notices
    session_start(); // Start session
?>

<?php
    $uname = $_SESSION["username"]; // Retrieve username from session
?>
<?php
...
<div class="container">
    <h2>Latest Updates on Complaints and Guest Entries  : </h2>
    <ul>
        <li>
