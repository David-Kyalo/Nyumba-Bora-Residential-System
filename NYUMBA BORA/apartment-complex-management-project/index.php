<?php 
    ...
    $showresults = ""; // Initialize $showresults variable
...
<style>
    body {
        background-image: url(./Assets/IMAGES/marla.jpg);
...
<body>
    <nav class="navbar navbar-light bg-light">
        <span class="navbar-brand mb-0 h1">NYUMBA BORA RESIDENTIAL MANAGEMENT SYSTEM</span>
    </nav>
            ...
            <div class="col-sm-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">Manage resident Database, handle complaints, and view & manage Guests here...</p>
            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">Lodge complaints; write literally
    ...
    <div class="container" style="margin-top: 30px;">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Apartment Enquiry</h5>
                        <p class="card-text">Fancy an apartment in our Complex?  <br> Decide your BHK Specification and shortlist your dream house!</p>
                        <p class="card-text"><form method="post">
                            <div class="form-group">
                                <label>BHK (Bedroom, Hall and Kitchen) Specification</label>
