...
-- Database: `apartments`
--
CREATE DATABASE IF NOT EXISTS `apartments` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `apartments`;
...
INSERT INTO `admin` (`ID_NO`, `EMAIL`, `NAME`, `PASSWORD`) VALUES
(1, 'gerry@gmail.com', 'gerry', 'gerrygerry'),
(2, 'Samido@gmail.com', 'samido', 'samidosamido'),
(3, 'wajackoya@gmail.com', 'wajackoya', 'wajackoyah');
...
INSERT INTO `comp_resolution` (`COMPLAINT_ID`, `COMP_SUBJECT`, `COMP_HANDLER`, `HANDLER_PHONE`) VALUES
(8, 'General', 'Arnav Kumar', 978984798),
(10, 'Dry Repairs', 'Rajesh C', 9887756651),
(13, 'Drinking Water', 'Kumar Proteek', 6942069420),
(15, 'Wet Repairs', 'Prashanth', 6969696969);
...
INSERT INTO `formerresident` (`RES_ID`, `NAME`, `PHONE_NO`, `EMAILID`, `FEEDBACK`, `EXITTIMESTAMP`) VALUES
(3, 'Angela munyi', 5465478952, 'merkel@gmail.de', 'Null', 1541866034),
(4, 'Joleen kiptoo', 7945620130, 'OPTED OUT', 'The complex is perfect. No significant improvements whatsoever are required.', 1541926248),
(7, 'Ching njoro', 1234559876, 'chingchong@bingbong.com', 'Null', 1541926811),
(9, 'Lauri chege', 9875623568, 'chau911@koreanmilitaryservices.org', 'Null', 1541932615),
(11, 'Delilah njeri', 9785642364, 'delilah.9001@gmail.com', 'Null', 1541933426),
(15, 'Ben Dovernaugh', 5465465465, 'bendover@outlook.uk', 'Solar panels need improvement.', 1542007563),
(16, 'Mike kamau', 9785512365, 'mike@w3wildhunt.com', 'Null', 1542021314),
(17, 'Arnav Kumar', 1234586558, 'OPTED OUT', 'The pipes around my building are too leaky. A lot of repairs and to no avail.', 1542098407),
(19, 'Charles otieno', 5648484799, 'charles@gmail.com', 'Have to improve on the drinking water supply.', 1543594458);
...
CREATE TABLE `guest` (
  ...
  `DATE_OE` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
